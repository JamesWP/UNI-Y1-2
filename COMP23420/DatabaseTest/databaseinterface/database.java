...
public class database
{
  ...
  public static void openBusDatabase()
  {
    try
    {
      busDatabase = new database("2014_comp23420_r11", "mbax3jp2","mbax3jp2dat",
                                 "jdbc:mysql://dbhost.cs.man.ac.uk:3306","com.mysql.jdbc.Driver");
      busDatabase.open();
    }
    catch (Exception ex)
    {
  ...
  public static void closeBusDatabase()
  {
    busDatabase.close();
  }
