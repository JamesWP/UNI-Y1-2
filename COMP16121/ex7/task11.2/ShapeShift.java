...
public class ShapeShift
{
  ...
  public static void main(String[] args)
  {
    ...
    switch (shapeChoice)
    {
      ...
      // Polygon.
      case 4:
        Point pointOne   = inputPoint("Enter one corner as X Y: ");
        Point pointTwo   = inputPoint("Enter two corner as X Y: ");
        Point pointThree = inputPoint("Enter three corner as X Y: ");
        Point pointFour  = inputPoint("Enter four corner as X Y: ");
        Polygon originalPolygon = new Polygon(pointOne,pointTwo,
